...
namespace ConvertExtension.Extension
{
    ...
    [Guid(GuidList.guidWebFormsRazorConverterVsExtensionPkgString)]
    public sealed class WebFormsRazorConverterVsExtensionPackage : Package
    {
        /// <summary>
